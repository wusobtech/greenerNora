                                ...
                                @foreach ($products as $product)
                                    <div class="col-6 col-md-4 col-lg-4">
                                        <div class="product product-7 text-center">
                                            ...
                                            <span class="product-label label-new">{{$product->type}}</span>
                                                <a href="product.html">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="{{route('product')}}">{{$product->name}}</a></h3><!-- End .product-title -->
                                        ...
                                        <div class="filter-items">
                                            <div class="filter-item">
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <label class="custom-control-label" for="size-1">Chicken</label>
                                            ...
                                            <div class="filter-item">
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <label class="custom-control-label" for="size-2">Turkey</label>
                                                </div><!-- End .custom-checkbox -->
                                            </div><!-- End .filter-item -->
                                            ...
                                            <div class="filter-item">
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <label class="custom-control-label" for="size-3">Guinea Fowl</label>
                                                </div><!-- End .custom-checkbox -->
                                            </div><!-- End .filter-item -->
                                            ...
                                            <div class="filter-item">
                                                <div class="custom-control custom-checkbox">
                                                    ...
                                                    <label class="custom-control-label" for="size-4">Titus Fish</label>
                                                </div><!-- End .custom-checkbox -->
                                            </div><!-- End .filter-item -->
